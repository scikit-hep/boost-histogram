...
class any_double_sparse(_BaseHistogram):
    def __idiv__(self, other: any_double_sparse) -> Self: ...
    def __imul__(self, other: any_double_sparse) -> Self: ...
    def at(self, *args: int) -> float: ...
    def _at_set(self, value: float, *args: int) -> None: ...
    def sum(self, flow: bool = ...) -> float: ...
    def _to_coo(
        self, flow: bool = ...
    ) -> tuple[np.typing.NDArray[np.intp], np.typing.NDArray[np.float64]]: ...
    def _from_coo(
        self,
