...
class any_collector(_BaseHistogram):
    def at(self, *args: int) -> list[float]: ...
    def _at_set(self, value: list[float], *args: int) -> None: ...
    def sum(self, flow: bool = ...) -> list[float]: ...

class any_weighted_collector(_BaseHistogram):
    def at(self, *args: int) -> list[tuple[float, float]]: ...
    def _at_set(self, value: list[tuple[float, float]], *args: int) -> None: ...
    def sum(self, flow: bool = ...) -> list[tuple[float, float]]: ...
