...
class any_int64(_BaseHistogram):
    def __itruediv__(self, other: any_int64) -> Self: ...
...
class any_unlimited(_BaseHistogram):
    def __itruediv__(self, other: any_unlimited) -> Self: ...
...
class any_double(_BaseHistogram):
    def __itruediv__(self, other: any_double) -> Self: ...
...
class any_atomic_int64(_BaseHistogram):
    def __itruediv__(self, other: any_atomic_int64) -> Self: ...
...
class any_weight(_BaseHistogram):
    def __itruediv__(self, other: any_weight) -> Self: ...
...
class any_multi_cell(_BaseHistogram):
    def at(self, *args: int) -> float: ...
    def _at_set(self, value: float, *args: int) -> ArrayLike: ...
    def sum(self, flow: bool = ...) -> ArrayLike: ...
    def nelem(self) -> int: ...
    def reset_nelem(self, nelem: int) -> None: ...

class any_collector(_BaseHistogram):
    def at(self, *args: int) -> accumulators.Values: ...
    def _at_set(self, value: accumulators.Values, *args: int) -> None: ...
    def sum(self, flow: bool = ...) -> accumulators.Values: ...

class any_weighted_collector(_BaseHistogram):
    def at(self, *args: int) -> accumulators.WeightedValues: ...
    def _at_set(self, value: accumulators.WeightedValues, *args: int) -> None: ...
    def sum(self, flow: bool = ...) -> accumulators.WeightedValues: ...
