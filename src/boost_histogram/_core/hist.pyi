...
class _BaseHistogram:
    ...
    def __init__(
        self, axes: list[axis._BaseAxis], storage: storage._BaseStorage = ...
    ) -> None: ...
    def rank(self) -> int: ...
    def size(self) -> int: ...
    def reset(self) -> None: ...
    ...
    def _set_axis_metadata(self, i: int, metadata: dict[str, Any]) -> None: ...
    def fill(
        self,
        *args: ArrayLike,
...
class any_int64(_BaseHistogram):
    def __isub__(self, other: any_int64) -> Self: ...
...
class any_unlimited(_BaseHistogram):
    def __isub__(self, other: any_unlimited) -> Self: ...
...
class any_double(_BaseHistogram):
    def __isub__(self, other: any_double) -> Self: ...
...
class any_multi_cell(_BaseHistogram):
    def __isub__(self, other: any_multi_cell) -> Self: ...
    def at(self, *args: int) -> list[float]: ...
    def _at_set(self, value: ArrayLike, *args: int) -> None: ...
